...
public class Arm extends TimedRobot {
  private static final int leaderDeviceID = ArmConstants.leaderDeviceID;
  private static final int followerDeviceID = ArmConstants.followerDeviceID;
  ...
  public void teleopPeriodic() {
    ...
    SmartDashboard.putNumber("Output For Leading Motor", m_leaderMotor.getAppliedOutput());
    SmartDashboard.putNumber("Output For Following Motor", m_followerMotor.getAppliedOutput());
  }
}
